class SupabaseOptions {
  ...
  static void ensureConfigured() {
    if (url.isEmpty || anonKey.isEmpty) {
      throw ArgumentError(
        'Supabase credentials are missing. Provide NEXT_PUBLIC_SUPABASE_LUBER_PUBLIC_SUPABASE_URL/NEXT_PUBLIC_SUPABASE_LUBER_PUBLIC_SUPABASE_ANON_KEY (or SUPABASE_URL/SUPABASE_ANON_KEY) via --dart-define.',
      );
    }
  }
}
